...
export default function ContactCard({ contact, setOpenedContact }: ContactCardProps) {
    return (
        <div className="bg-neutral-100 dark:bg-slate-700 p-5 w-fit rounded-md m-4 shadow-md flex-grow basis-0 cursor-pointer transition-all hover:shadow-xl hover:-translate-y-1" onClick={() => setOpenedContact(contact)}>
